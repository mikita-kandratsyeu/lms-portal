...
export const CategoryManager = () => {
  ...
  const t = useTranslations('owner.configurations.categories');
  ...
  const fetchCategories = async () => {
    try {
      setIsLoading(true);
      const response = await fetcher.get('/api/configurations/category', { responseType: 'json' });
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      await fetcher.delete(`/api/configurations/category/${id}`, { responseType: 'json' });
  ...
  return (
    <Card className="shadow-none">
      ...
      <CategoryDialog isOpen={isDialogOpen} onClose={handleDialogClose} editingItem={editingItem} />
    </Card>
  );
};
